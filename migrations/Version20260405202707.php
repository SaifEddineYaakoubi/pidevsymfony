...
final class Version20260405202707 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        // MariaDB does not support RENAME INDEX in all versions; recreate the index instead
        $this->addSql('DROP INDEX id_parcelle ON culture');
        $this->addSql('CREATE INDEX IDX_B6A99CEB95B5C063 ON culture (id_parcelle)');
        ...
        $this->addSql('ALTER TABLE parcelle ADD CONSTRAINT FK_C56E2CF66B3CA4B FOREIGN KEY (id_user) REFERENCES utilisateur (id_user)');
        // MariaDB: recreate the index instead of renaming
        $this->addSql('DROP INDEX id_user ON parcelle');
        $this->addSql('CREATE INDEX IDX_C56E2CF66B3CA4B ON parcelle (id_user)');
        ...
        $this->addSql('DROP INDEX id_culture ON recolte');
        $this->addSql('CREATE INDEX IDX_3433713C6834359B ON recolte (id_culture)');
        ...
        $this->addSql('DROP INDEX id_produit ON stock');
        $this->addSql('CREATE INDEX IDX_4B365660F7384557 ON stock (id_produit)');
        ...
        $this->addSql('DROP INDEX id_client ON vente');
        $this->addSql('CREATE INDEX IDX_888A2A4CE173B1B8 ON vente (id_client)');
        $this->addSql('DROP INDEX id_user ON vente');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_B6A99CEB95B5C063 ON culture');
        $this->addSql('CREATE INDEX id_parcelle ON culture (id_parcelle)');
