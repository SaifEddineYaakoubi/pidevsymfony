...
final class Version20260406205550 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        // Optional legacy tables might not exist in all environments.
        // Use conditional drops to avoid blocking the migration.
        $this->addSql('DROP TABLE IF EXISTS alerte');
        $this->addSql('DROP TABLE IF EXISTS historique_action');
        $this->addSql('DROP TABLE IF EXISTS ligne_vente');
        ...
        // This migration was generated against a specific legacy schema and is often applied
        // on databases that already contain (parts of) the final schema.
        // To keep it resilient across environments (MariaDB/MySQL, fresh/dirty DB), we avoid:
        //  - dropping foreign keys / indexes that may not exist
        //  - adding foreign keys that may already exist or would fail due to orphan rows
        //  - RENAME INDEX (not supported on all MariaDB versions)
        // We only keep safe column/type adjustments below.
        ...
        // Avoid adding/renaming indexes or FKs here; they may already exist.
        ...
        // Skip adding recolte FK/renaming index: often already present and may conflict (errno 121).
        ...
        // Skip adding stock FK/renaming indexes: often already present and may conflict (errno 121).
